...
import com.cpsolutions.net.InitHttpPostRequest;
import com.cpsolutions.net.NameValuePair;
import com.cpsolutions.utils.DateTimeUtils;
import com.cpsolutions.utils.FileUtils;

public class ServiceFileDownloaderPost extends AbsServiceFileDownloaderPost {
	...
	/**
	 * Interface used to handle callbacks to set the POST's headers.
	 */
	private InitHttpPostRequest initHttpPostRequest = null;
	...
	public ServiceFileDownloaderPost(String url, int notificationId, Service service) throws MalformedURLException {
		super(url, service);
	...
	/**
	 * Register callbacks to be invoked when this POST's headers need to be initialized.
	 * 
	 * @param initHttpRequest the callback that will run
	 */
	public void setInitHttpPostRequest(InitHttpPostRequest initHttpPostRequest) {
		this.initHttpPostRequest = initHttpPostRequest;
	}
	...
	protected void setRequestHeaders(List<NameValuePair> headers, String url) {
		if(initHttpPostRequest != null) {
			initHttpPostRequest.setRequestHeaders(headers, url);
		}
	}

	@Override
	protected void setRequestParameters(List<NameValuePair> parameters, String url) {
		if(initHttpPostRequest != null) {
			initHttpPostRequest.setRequestParameters(parameters, url);
		}
	}
}
