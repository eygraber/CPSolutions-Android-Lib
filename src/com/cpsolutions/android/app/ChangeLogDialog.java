...
public class ChangeLogDialog {
    ...
    /**
     * FragmentManager used to display the DialogFragment
     */
     ...
     *         FragmentManager that is used to show the DialogFragment.
     */
    public ChangeLogDialog(Context context, FragmentManager fragmentManager) {
        this(context, fragmentManager, PreferenceManager.getDefaultSharedPreferences(context), DEFAULT_CSS);
    }
     ...
     */
    public ChangeLogDialog(Context context, FragmentManager fragmentManager, String css) {
        this(context, fragmentManager, PreferenceManager.getDefaultSharedPreferences(context), css);
    }
     ...
     *
     */
    public ChangeLogDialog(Context context, FragmentManager fragmentManager, SharedPreferences preferences, String css) {
        mContext = context;
        mCss = css;
    ...
    public void showLogDialog() {
    	...
    	frag.setDialog(getDialog(isFirstRunEver()));
    	frag.show(mFragmentManager, "dialog");
    }

    /**
     * Get a dialog with the full change log.
     */
    public void showFullLogDialog() {
    	ChangeLogDialogFragment frag = new ChangeLogDialogFragment();
    	frag.setDialog(getDialog(true));
    	frag.show(mFragmentManager, "dialog");
    }
